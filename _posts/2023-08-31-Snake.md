...
<div class="container">
    <header class="pb-3 mb-4 border-bottom border-primary text-dark">
        ...
        <p class="fs-4">Snake high-score: <span id="highscore_value">0</span></p>
    </header>
    <div class="container bg-secondary" style="text-align:center;">
        ...
        <div id="gameover" class="py-4 text-light">
            <p>You're garbage and lost loser, press <span style="background-color: #FFFFFF; color: #000000">space</span> to try again</p>
...
<script>
    (function(){
        ...
        const ele_highscore = document.getElementById("highscore_value");
        ...
        let newGame = function(){
            ...
            ele_highscore.innerHTML = String(highscore);
            score = 0;
            altScore(score);
        ...
        let setWall = function(wall_value){
            ...
            if(wall === 1){screen_snake.style.borderColor = "#444444";}
        }
    })();
</script>